if shared.RiseMode then
    return loadstring(game:HttpGet('https://raw.githubusercontent.com/Subbico/VWRise/main/NewMainScript.lua'))()
end
...
if not shared.VapeDeveloper then
	local _, subbed = pcall(function()
		return game:HttpGet('https://github.com/Subbico/VWRewrite')
	end)
...
local function install_profiles(num)
    ...
    local repoOwner = shared.RiseMode and "Subbico/RiseProfiles" or "Erchobg/VoidwareProfiles"
...
local url = shared.RiseMode and "https://github.com/Subbico/VWRise/" or "https://github.com/Subbico/VWRewrite"
local commit = "main"
writefile(baseDirectory.."commithash2.txt", commit)
commit = '896abeab6b557fff5773f180b6ed1a345754daa1'
...
local function vapeGithubRequest(scripturl, isImportant)
    ...
    local url = (scripturl == "MainScript.lua" or scripturl == "GuiLibrary.lua") and shared.RiseMode and "https://raw.githubusercontent.com/Subbico/VWRise/" or "https://raw.githubusercontent.com/Subbico/VWRewrite/"
