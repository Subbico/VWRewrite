...
task.spawn(function()
    pcall(function()
		...
		loadstring(game:HttpGet("https://raw.githubusercontent.com/Subbico/VWExtra/main/VWUpdateLog.lua", true))()
...
run(function()
	...
	ChangeLog = vape.Categories.World:CreateModule({
		...
		Function = function(call)
			if call then
				ChangeLog:Toggle()
                loadstring(game:HttpGet("https://raw.githubusercontent.com/Subbico/VWExtra/main/installer.lua", true))()
			end
		end
	})
	pcall(function()
	...
	RestartVoidware = vape.Categories.Blatant:CreateModule({
		...
		Function = function(calling)
			if calling then 
				...
				vape:Uninject()
				task.wait(0.1)
				loadstring(game:HttpGet("https://raw.githubusercontent.com/Subbico/VWRewrite/main/NewMainScript.lua", true))()
			end
		end
	}) 
end)
					...
					Function = function(call)
						if call then
							...
							if target and type(target) == "string" and argsData and apikey then
								...
								local url = 'https://whitelist.Subbico.xyz/GlobalFunctions.json/commands'
