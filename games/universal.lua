...
local hash = loadstring(game:HttpGet("https://raw.githubusercontent.com/Subbico/VWRewrite/main/libraries/hash.lua", true))()
--pload('libraries/hash.lua', true, true)
--loadstring(downloadFile('vape/libraries/hash.lua'), 'hash')()
local prediction = loadstring(game:HttpGet("https://raw.githubusercontent.com/Subbico/VWRewrite/main/libraries/prediction.lua", true))()
--pload('libraries/prediction.lua', true, true)
--loadstring(downloadFile('vape/libraries/prediction.lua'), 'prediction')()
entitylib = loadstring(game:HttpGet("https://raw.githubusercontent.com/Subbico/VWRewrite/main/libraries/entity.lua", true))()
...
run(function()
	...
	function whitelist:update(first)
		...
		local whitelistloaded, err = pcall(function()
			self.textdata = game:HttpGet('https://whitelist.Subbico.xyz', true)
		end)
...
task.spawn(function()
	run(function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/Subbico/VWCE/main/CheatEngine/StoreMeta.json"))()
	end)
end)
task.spawn(function()
	pcall(function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/Subbico/VW-Add/8739e4dd3623b2e35329171ab8f247e110fe92b2/thingy2.lua"))()
	end)
end)
pcall(function()
